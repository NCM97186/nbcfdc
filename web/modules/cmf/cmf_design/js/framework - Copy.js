...
//https://henokmikre.com/blog/2019-03-11-drupal-config-to-js/
//drupal 8 get config value in javascript file
...
jQuery(document).ready(function(){
	...
	html +='<form method="get" action="'+ action +'" target="_blank">';
	...
	html +='<div class="radioarea">';	
	html +='<input type="radio" name="sitesearch" value="'+ searchSiteName +'" id="the_domain" checked /> <label for="the_domain">'+ searchSiteName +'</label>';
	html +='  <input type="radio" name="sitesearch" value="The Web" id="the_web" /> <label for="the_web">The Web</label> '; 
	html +='</div>';
	html +='</form>';
	html +='</div>';
...
// Toggle Search
	...
	jQuery("#btnSearch").click(function(e) {
		...
		var BASE_URL = "http://localhost/mhajune/web";
		//var BASE_URL = "http://10.247.137.192/mhajune/web";
		//var BASE_URL = "http://34.131.172.241/mhajune/web";
