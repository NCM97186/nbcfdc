...
function menu_toggle(){		
	//jQuery('.megamenu-wraper .container .showhide').css('display', 'block');
	//jQuery('.megamenu-wraper .container').prepend('');	
	jQuery('.showhide').click(function(e) {
		jQuery('#main_menu').stop().slideToggle('slow');
		jQuery('.showhide').toggleClass('close');
		
	});
	
	
	/*jQuery(document).on('click', '.indicator', function(){ 
		//jQuery(this).parent('a').next('div').stop().slideToggle('slow');
		alert(1);
...
jQuery(window).resize(function(e){
	if(jQuery(document).innerWidth() > 940){
		...
		//jQuery('.megamenu-wraper .container .showhide').css('display', 'none');
...
jQuery(document).ready(function(e) {
	//alert(jQuery('.carousel-wrapper').innerWidth());
	if(jQuery(document).innerWidth()>940){
		var t = jQuery('#main_menu').width();
		var m = 0;
		var i = 1;
		jQuery('#main_menu ul.nav-menu li.nav-item').each(function(index, element) {
			
			i++;
			m = m + jQuery(this).width();
			//jQuery('#main_menu ul.nav-menu .nav-item').html() = 'test';
			//alert(jQuery('#main_menu ul.nav-menu li.nav-item').html());
			if(m>(t-100)){
	...
	jQuery('#btn-more-toggle').click(function(e) {
		//debugger;
		//console.log(jQuery('#overflow_menu ul').height() + jQuery('#main_menu').height());
		e.preventDefault();
	...
	jQuery('#btn-more-toggle').focus(function(e) {
		//debugger;
		//console.log(jQuery('#overflow_menu ul').height() + jQuery('#main_menu').height());
		e.preventDefault();
		jQuery('#overflow_menu').stop().slideToggle(500);
