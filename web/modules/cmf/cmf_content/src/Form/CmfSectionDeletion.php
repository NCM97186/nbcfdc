...
class CmfSectionDeletion extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
	...
	/* New Page Subsection Deletion */
	$form['newpage_subsection_deletion'] = [
		'#type' => 'details',
		'#title' => t('Clear New Page Subsection Data'),
		'#open' => true,
	];
	$form['newpage_subsection_deletion']['newpage_subsection_deletion_name'] = array(
		'#title' => t('Click Below Link to Clear New Page Subsection Deleted Data'),
		'#type' => 'details',
		'#open' => true,
		'#description' => t('<a href="/delete_newpage_subsection_data.php" >Click Me</a> to Clear New Page Subsection Data.'),
		'#required' => false,
