...
class CmfSectionDeletion extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
	...
	$form['section_deletion']['section_deletion_name'] = array(
		...
		'#type' => 'details',
		'#open' => true,
		'#description' => t('<a href="/delete_section_data.php" >Click Me</a> to Clear Section and Subsection Data.'),
		'#required' => false,
		'#default_value' => $deletesection->get('section_deletion_name'),
	);	

	/* Section Subsection Deletion */
	$form['section_subsection_deletion'] = [
		'#type' => 'details',
		'#title' => t('Clear New SectionSubsection Pages Data'),
		'#open' => true,
	];
	$form['section_subsection_deletion']['section_subsection_deletion_name'] = array(
		'#title' => t('Click Below Link to Clear New SectionSubsection Page Deleted Data'),
		'#type' => 'details',
		'#open' => true,
		'#description' => t('<a href="/delete_section_subsection_data.php" >Click Me</a> to Clear New SectionSubsection Page Data.'),
		'#required' => false,
		'#default_value' => $deletesection->get('section_subsection_deletion_name'),
	);		
	...
	$form['cache_clear']['cache_clear_data'] = array(
		...
		'#type' => 'details',
		'#open' => true,
		'#description' => t('<a href="/clear_cache.php" >Click Me</a> to Clear Cache Data.'),
		'#required' => false,
