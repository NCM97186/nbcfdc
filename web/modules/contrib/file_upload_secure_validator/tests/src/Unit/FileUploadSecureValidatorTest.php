...
class FileUploadSecureValidatorTest extends UnitTestCase {
  ...
  public function fileUploadScenariosProvider() {
    return [
      [
        'case' => 'Missing file',
        'uri' => '/tmp/missing_file.pdf',
        'mimetype' => 'application/pdf',
        'expectedError' => new TranslatableMarkup('Caught a FileNotFoundException; cannot validate missing file requested as @path', [
          '@path' => '/tmp/missing_file.pdf',
        ], [], $this->getTranslationManagerMock()),
      ],
      [
        'case' => 'True extension',
